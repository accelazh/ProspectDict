 ...
 *
 */
public class MagDialog extends JDialog
implements MouseListener, MouseMotionListener, Magnetic
{
	//for debug
	...
	public MagDialog(MagGroup group)
	{
		if(group!=null)
		{
			group.add(this);
	...
	public void mouseDragged(MouseEvent e) 
	{
		if (debug) 
		{
			System.out.println("mouseDragged and process dragMoving");
		}
