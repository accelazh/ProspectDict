 ...
 *
 */
public class InstallPanelForBackupFinished extends InstallerPanelSuper
{
	public static final String LABEL_INFO="Back-up Finished. ";
	
	private JTextArea label=new JTextArea(LABEL_INFO);
	
	private Installer installer;
	
	public InstallPanelForBackupFinished()
	{
		super();
	...
	public static void main(String[] args)
	{
		...
		frame.getContentPane().add(new InstallPanelForBackupFinished());
