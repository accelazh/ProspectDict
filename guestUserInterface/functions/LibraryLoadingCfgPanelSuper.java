 ...
 *
 */
public abstract class LibraryLoadingCfgPanelSuper extends JPanel 
implements Constants, ActionListener
{
	...
	public LibraryLoadingCfgPanelSuper()
	{
		//self initialization
		setLayout(new BorderLayout());
        	
		//initialize component
		leftLabel.setIcon(new ImageIcon("GUISource\\loadingCfgLeftLabel.gif"));
