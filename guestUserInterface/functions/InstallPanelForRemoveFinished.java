...
/**
 * 这个类用于制作安装界面，负责remove的面板之一
 * @author ZYL
 *
 */
public class InstallPanelForRemoveFinished extends InstallerPanelSuper
{
	public static final String LABEL_INFO="Remove Finished. ";
	
	private JTextArea label=new JTextArea(LABEL_INFO);
	
	private Installer installer;
	
	public InstallPanelForRemoveFinished()
	{
		super();
	...
	public static void main(String[] args)
	{
		...
		frame.getContentPane().add(new InstallPanelForRemoveFinished());
